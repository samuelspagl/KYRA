...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1382.0, 134.1851806640625, 52.0, 22.0 ],
					"text" : "mute $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1402.0, 242.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1382.0, 70.0, 28.0, 22.0 ],
					"saved_object_attributes" : 					{
...
,
					"patching_rect" : [ 309.0, 630.62158203125, 61.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 291.51849365234375, 48.0, 35.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : "Signal"
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1168.0, 231.8148193359375, 74.0, 22.0 ],
					"text" : "unpack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 951.9429931640625, 242.0, 74.0, 22.0 ],
					"text" : "unpack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 712.5, 242.0, 74.0, 22.0 ],
					"text" : "unpack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 484.0, 242.0, 74.0, 22.0 ],
					"text" : "unpack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 644.5, 366.8148193359375, 50.0, 22.0 ]
				}
